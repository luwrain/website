...
?>
    ...
    <em>"Информационное общество &#x2014; доступное общество"</em>
    <p>Команда LUWRAIN развивает инструменты доступа к&#160;информационным технологиям в&#160;невизуальной форме.
      Наша&#160;компетенция включает в&#160;себя как решение социальных задач, так и
      исследования новых человеко-машинных интерфейсов для&#160;"Интернета вещей" и "Умного дома".
      Особую роль в&#160;работе играет поддержка людей с&#160;нарушениями зрения,
      для&#160;которых мы ведём активную разработку программных продуктов и методов адаптаций материалов.</p>

    <p>На&#160;основе виртуальной машины Java  мы разрабатываем платформу для&#160;построения эффективного невизуального       интерфейса.
      В&#160;отличие от&#160;экранных чтецов, функционирующих в&#160;оконном окружении, LUWRAIN представляет информацию в&#160;виде, адаптированном для восприятия людей с&#160;нарушениями зрения.
      Это означает, что на&#160;работу в&#160;LUWRAIN пользователю требуется времени существенно
      меньше, чем в&#160;оконном интерфейсе. Мы создаём нашу систему для&#160;тех, кто ведёт
      активный образ жизни и ценит экономию времени.</p>

    <p>Как из&#160;совокупности текста, различных цветов фона и  графических примитивов рождаются новые образы,
      воспринимаемые человеком визуально,
      так&#160;же из&#160;речи и звуков рождаются образы,
      воспринимаемые на&#160;слух.
      Мы называем  это невизуальным дизайном,
      который проектируем, исходя из&#160;требований функциональной эффективности.
      Наш опыт показывает, что в&#160;правильно спроектированном невизуальном интерфейсе
      работа  может быть такой&#160;же комфортной и быстрой,
      как и с&#160;использованием обычных графических инструментов.</p>

    <p>Основные компоненты LUWRAIN являются свободным ПО и созданы с&#160;активным использованием результатов других свободных проектов.
      Мы намерены привлекать как можно больше внимания к&#160;решению социальных задач при&#160;помощи свободного ПО
      и к&#160;тем премуществам, которые оно открывает.
      Наряду с&#160;другими видами поставки  LUWRAIN распространяется как&#160;дистрибутив GNU/Linux,
