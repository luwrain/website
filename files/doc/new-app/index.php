...
<?php if (luwrain_current_lang() == 'ru') {?>
                ...
                <ol>
                  ...
                  <li>События приложений.</li>
                  <li>Библиотека стандартных элементов управления.</li>
                  <li>Создание собственных элементов управления.</li>
                  <li>Библиотека стандартных всплывающих областей.</li>
                  <li>Создание многопоточных приложений.</li>
