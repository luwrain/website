...
<?php if (luwrain_current_lang() == 'ru') {?>
                ...
                <ul>
                  ...
                  <li>события среды;</li>
                  <li>
                    события синхронизации потоков (являются потомками событий среды, поэтому для&#160;событий
                ...
                <p>
                  ...
                  новой копии. Если текущее активное приложение отвечает отказом обработать посланную команду,
