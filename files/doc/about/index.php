...
<h2>Расширяемость и взаимодействие с&#160;сетевыми сервисами</h2>

<p>Возможность расширения функциональности системы при&#160;помощи скриптов  и сторонних компонентов&#160;&#x2014;  важнейшая часть философии LUWRAIN.
По&#160;мере необходимости все&#160;желающие люди могут дополнять функции LUWRAIN своими программами на&#160;языке <a href="https://ru.wikipedia.org/wiki/JavaScript">JavaScript</a>.
Созданные программы будут выполняться движком <a href="https://ru.wikipedia.org/wiki/Nashorn_%28%D0%B4%D0%B2%D0%B8%D0%B6%D0%BE%D0%BA_JavaScript%29">Nashorn</a>,
входящим в&#160;состав виртуальной машины Java
и тесно интегрированным в&#160;ядро нашей системы.
JavaScript&#160;&#x2014; очень простой язык, освоение которого по&#160;силам любому человеку, интересующемуся современными ИТ.</p>

<p>Наша поддержка JavaScript очень многогранна.
...
и автоматизация однотипных преобразований текста в&#160;редакторах.</p>

<p>Ведя разработку LUWRAIN, мы опираемся  на&#160;большое количество готовых библиотек Java,
...
Одной из&#160;самых ценных возможностей является поддержка браузерного движка <a href="https://ru.wikipedia.org/wiki/WebKit">WebKit</a>,
...
что остаётся очень важной возможностью для&#160;людей с&#160;остаточным зрением.</p>

<p>Идея расширения функциональности при&#160;помощи библиотек неразрывно связана с&#160;интеграцией LUWRAIN с&#160;сетевыми сервисами.
Появление всё&#160;большего количества публичных API&#160;&#x2014; один из&#160;самых явных современных трендов.
Примером может служить ожидаемое законодательное требование к&#160;российским банкам предоставлять доступ к&#160;своим услугам в&#160;машинночитаемом виде
(<a href="https://www.kommersant.ru/doc/4060395">статья по&#160;теме в&#160;газете "Коммерсантъ"</a>).
...
без&#160;"замирания" системы в&#160;периоды сетевого обмена.</p>

<p>Интеграция с&#160;сетевыми сервисами возможна на&#160;самом глубоком уровне.
Это&#160;необходимо для&#160;предоставления пользователю различных уведомлений о&#160;внешних событиях.
С&#160;использованием LUWRAIN пользователь способен получать оповещения, скажем, из&#160;<a href="https://developer.twitter.com/en/docs/tweets/filter-realtime/overview.html">Twitter Streaming API</a>,
слышать сообщения из&#160;социальных сетей  и чувствовать себя полноценно интегрированным в&#160;цифровое пространство.</p>

<h2>Социальная и научная миссия</h2>

<p>Наш&#160;коллектив видит возможность решения ряда социальных и научных задач
при&#160;помощи разрабатываемых нами технологий.
Ниже перечислены некоторые направления, на&#160;которые мы особенно хотели&#160;бы обратить внимание:</p>

<ol>
<li><strong>Использование издательских систем
<a href="https://ru.wikipedia.org/wiki/TeX">TeX</a>
и
<a href="https://ru.wikipedia.org/wiki/LilyPond">Lilypond</a>.</strong>
...
диссертаций (<a href="http://marigostra.ru/materials/thesis.pdf">пример</a> и <a href="http://marigostra.ru/materials/thesis-src.zip">его&#160;исходные тексты</a>),
книг, статей,
презентаций (<a href="http://marigostra.ru/materials/KamerataTeX2018.html">вебинар, посвящённый этой&#160;теме</a>),
нотных партитур (<a href="http://marigostra.ru/piano/LittlePrelude.pdf">пример</a> и <a href="http://marigostra.ru/piano/LittlePrelude.zip">его&#160;исходные тексты</a>)
и&#160;пр.
...
который  упростит и ускорит редактирование файлов в&#160;их&#160;форматах.</li>
<li><strong>Использование GNU/Linux.</strong>
Преимущества GNU/Linux способны принести существенную пользу людям с&#160;нарушениям зрения,
...
Мы видим здесь хорошую возможность облегчить знакомство людей с&#160;нарушениями зрения с&#160;GNU/Linux и сделать это&#160;окружение более дружелюбным.</li>
</ol>
<?php }?>
