...
а&#160;также не&#160;требуя от&#160;пользователя запускать конкретную операционную систему (которая тоже во&#160;многих случаях может быть недоступна организациям по&#160;финансовым причинам).</li>
</ol>
<?php }?>
