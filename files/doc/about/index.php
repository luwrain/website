...
входящего в&#160;состав виртуальной машины Java
и тесно интегрированного в&#160;ядро нашей системы.
JavaScript&#160;&#x2014; очень простой язык, освоение которого по&#160;силам любому человеку, интересующемуся современными ИТ.</p>

<p>Поддержка JavaScript в&#160;нашей системе очень многогранна.
...
Развитие направления невизуальных интерактивных приложений мы считаем очень важным,
потому что оно способно открыть новое комплексное направление в&#160;тифлопедагогике,
...
К&#160;числу таких возможностей относятся вычисление математических выражений в&#160;нашем калькуляторе,
в&#160;котором строка, введённая пользователем, обрабатывается просто как формула JavaScript,
и автоматизация однотипных преобразований текста в&#160;текстовых редакторах.</p>
...
воспроизводить музыкальные файлы и делать множество прочих вещей.
...
используя который LUWRAIN способен загружать сайты,
...
<p>Возможность расширения функциональности при&#160;помощи библиотек неразрывно связана с&#160;возможностью интеграции LUWRAIN с&#160;сетевыми сервисами.
...
Невизуальная библиотека элементов управления  LUWRAIN поддерживает механизмы многопоточного выполнения кода,
что крайне важно, чтобы пользователь получал полное представление о&#160;состоянии процесса взаимодействия,
без&#160;"замирания" системы в&#160;периоды сетевого обмена.</p>

<p>Интеграция с&#160;сетевыми сервисами возможна на&#160;самом глубоком уровне.
Это&#160;необходимо для&#160;предоставления пользователю различных уведомлений о&#160;событиях.
С&#160;использованием LUWRAIN пользователь способен получать уведомления, скажем, из&#160;<a href="https://developer.twitter.com/en/docs/tweets/filter-realtime/overview.html">Twitter Streaming API</a>,
