...
<?php if (luwrain_current_lang() == 'en') {?>
                ...
                <p>
                  ...
                  which revolve around information technologies. There&#160;are some technical barriers making
                  this still very difficult and our development is&#160;carried&#160;out with&#160;the&#160;aim
                  of&#160;eliminating these barriers.
                </p>
                <ul>
                  <li>
                    LUWRAIN tries to&#160;bring information from&#160;PC&#x27;s to&#160;users in&#160;a&#160;way
                    adjusted to&#160;the&#160;perception of&#160;blind as&#160;best as&#160;possible
                  </li>
                  <li>Luwrrain allows creating and distributing of&#160;applications specially designed for&#160;blind</li>
                  <li>
                    LUWRAIN guarantees solving the&#160;number of&#160;popular everyday tasks regardless what
                    experience the&#160;user has or his/her financial circumstances
                  </li>
                </ul>
                <p>
                ...
                <p>
                  ...
                  popular current approach to&#160;assistive technologies for&#160;blind, doesn&#x27;t take
                  care of&#160;providing information in&#160;the&#160;form, suitable for&#160; the&#160;user
                  perception, what is the&#160;most noticeable disadvantage. Without using a&#160;mouse,
                  which is inaccessible for&#160;blind, this conception is totally ineffective. The&#160;level
                  of&#160;comfort and speed of&#160;work equal to&#160;the&#160;level of&#160;sighted people
                  remains still unreachable for&#160;blind users. Even more, if the&#160;user doesn&#x27;t
                  have any prior experience of&#160;using GUI as&#160;a&#160;sighted user, how he/she could
                  get a&#160;clew to&#160;understand its nature?
                </p>
                <p>
                  In&#160;order to&#160;replace inaccessible screen, the&#160;blind user always keeps the&#160;picture
                  of&#160;its working space in&#160;mind and Our goal is&#160;making this picture in&#160;imagination
                  <b>as&#160;simple as&#160;it&#160;could be&#160;possible</b>. This would allow &#160;user
                  to&#160;concentrate on&#160;its work more effectively. In&#160;case of&#160;screen readers,
                  the&#160;user is&#160;forced to&#160;keep in&#160;mind the&#160;whole look of&#160;the&#160;desktop
                  (what actually is&#160;impossible, regardless which tools are involved) and that destracts
                  him/her from the&#160;work itself. According to&#160;our&#160;experience, it&#160;is <b>really
                  possible</b> to&#160;create this&#160; new&#160;type of&#160;UI with the&#160;same features
                  as&#160;in&#160;usual GUI (of&#160;cource, if&#160;we&#160;are speaking about the&#160;tasks,
                  which are potentially accessible for&#160;blind; for&#160;instance, photo editing is&#160;inaccessible
                  at&#160;all due&#160;to&#160;its nature).
                </p>
                <p>
                  At&#160;a&#160;glance, it&#160;looks that we&#160;&#160;are presenting some kind of&#160;fiction,
                  generally impossible technology, but it&#160;isn&#x27;t the&#160;case. Everybody knows
                  that the&#160;text editing is the&#160;most understandable operation for&#160;blind on&#160;pc.
                  The&#160;only thing we should do is to&#160;make the&#160;solving of&#160;all tasks in&#160;the&#160;same
                  way as&#160;the&#160;text editing. How we achieve that, <a href="<?php echo luwrain_link('/doc/user/start/');?>">find&#160;out
                  with&#160;LUWRAIN</a>.
                </p>
                <p>
                ...
                <p>
                  We may witness a&#160;shift of&#160;solutions from&#160;web-browsers/desktop computers
                  to&#160;mobile platforms. In&#160;fact, it&#160;is a&#160;truely convenient approach, even
                ...
                <p>
                  Blind has nothing like this. There is no&#160;platform, which allows creating of&#160;the&#160;applications
                  ...
                  care of&#160;proper understanding of&#160;created applications by&#160;blind.
                </p>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    with&#160;proper Java&#160;1.8 support (roughly speaking, nearly on&#160;all&#160;PC&#x27;s)
                  </li>
                  <li>
                ...
                <p>
                  ...
                  2002 and never from this moment have been satisfied with them. However, I am pretty sure
                  that they are a&#160;great achievement and LUWRAIN isn&#x27;t a&#160;competitor disputing
                  their value. We would appreciate if everybody would take LUWRAIN as&#160;the&#160;project
                  creating something completely different, interesting and useful in&#160;areas previously
                  left without enough attention.
                </p>
                <p>
                  Besides that, I am very thankful to&#160;all <a href="http://emacspeak.sourceforge.net">emacspeak</a>
...
<?php if (luwrain_current_lang() == 'ru') {?>
                ...
                <ol>
                  ...
                  <li>
                    ...
                    версии 1.8, а она есть практически для&#160;любой современной ОС.
                  </li>
                  <li>
