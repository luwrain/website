...
<?php if (luwrain_current_lang() == 'ru') {?>
                ...
                <p>
                  ...
                  <i>--speech=</i>. Если этот параметр отсутствует или содержит пустое значение, то загрузка
                  LUWRAIN прерывается. Если загруженный класс не&#160;удовлетворяет интерфейсу <i>org.luwrain.speech.backEnd</i>,
