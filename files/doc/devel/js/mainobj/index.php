<?php include "../../../../functions.php"; luwrain_begin_page('/doc/devel/js/mainobj/index.php', luwrain_current_lang() == 'ru'?'Основной интерфейс LUWRAIN для программ на JavaScript':'The main interface of LUWRAIN for JavaScript extension');?>
...
<?php }?>
<?php luwrain_end_page('/doc/devel/js/mainobj/index.php');?>
