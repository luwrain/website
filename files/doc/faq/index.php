...
<p>Нет,
LLUWRAIN превосходно сочетается с&#160;другими вспомогательными технологиями.</p>
...
<ol>
<li>Приложения на&#160;основе LUWRAIN функционируют независимо от&#160;сторонних компонентов и позволят начать работать всем,
в то время как Jaws for Windows или NVDA присутствуют только у людей, уже имеющих опыт невизуальной работы с ПК.</li>
<li>LUWRAIN дополнит функциональность имеющейся интеграцией с&#160;интернет сервисами,
в&#160;то&#160;время как обычная оконная программа будет просто приложением.</li>
...
<li>Использование решения на основе LUWRAIN постоянно и единообразно для&#160;всех операционных систем,
...
<h2>Раз LUWRAIN целиком предназначен для&#160;невизуальной работы, значит, на&#160;экране ничего нет?</h2>
...
<h2>Если текст дублирует текстовое содержание, значит, на&#160;экране никогда не&#160;появляется никакой графики?</h2>
