...
<?php if (luwrain_current_lang() == 'en') {?>
                ...
                <h2>Who can be a&#160;user of&#160;Luwrain?</h2>
...
<?php if (luwrain_current_lang() == 'ru') {?>
                ...
                <p>
                  Нет, поскольку Luwrain может быть установлен в&#160;виде приложения на имеющуюся ОС. Пользователь
                  перенесёт в&#160;Luwrain выполнение только тех&#160;задач, какие пожелает. Помимо этого,
                  прежняя операционная система может быть необходима другим членам семьи или коллектива,
                  если они используют общий компьютер с&#160;человеком, имеющим нарушения зрения.
                </p>
                ...
                <p>
                  ...
                  Mac&#160;OS&#160;X и&#160;др.). Разработчики оконных систем изначально проектировали их
                  таким образом, чтобы получить наибольшую эффективность при&#160;работе мышью, так&#160;как
                  она является одним из&#160;самых удобных и наглядных способов управления рабочими объектами.
                  Вместе с&#160;тем, незрячим людям мышь недоступна, и это автоматически ограничивает их
                  скорость работы и уровень комфорта, поскольку они вынуждены заменять действия мышью действиями
                  на&#160;клавиатуре.
                </p>
                <p>
                  ...
                  отличий от&#160;близких разработок на&#160;<a href="<?php echo luwrain_link('/doc/difference/');?>">этой странице</a>.
                </p>
                ...
                <p>
                  ...
                  ПК. Для&#160;мобильных ПК лучше подходит версия Luwrain в&#160;виде самостоятельной ОС,
                  поскольку она задействует все возможные виды управления, включая <i>touch pad</i>, что
                  превращает ноутбук в&#160;элегантный и полезный аксессуар для&#160;незрячего человека.
                  Для&#160;настольного ПК, вероятно, лучше подойдёт версия Luwrain в&#160;виде приложения,
                  хотя установка в&#160;виде полной ОС остаётся всё&#160;равно возможной.
                </p>
                ...
                <p>
                  Мы намереваемся использовать компонент <a href="https://docs.oracle.com/javafx/2/api/javafx/scene/web/WebEngine.html">javafx.scene.web.WebEngine</a>
                  из&#160;состава JavaFX, поскольку он поддерживает Java&#160;Script и предоставляет доступ
                  к&#160;структуре DOM открытой страницы. Этот компонент основан на&#160;движке <a href="https://ru.wikipedia.org/wiki/WebKit">WebKit</a>,
                  который является базой некоторых распространённых браузеров, например, <a href="https://ru.wikipedia.org/wiki/Google_Chrome">Google
                  Chrome</a>. Помимо этого, Luwrain в&#160;виде самостоятельной ОС должен получить поддержку
                  Mozilla Firefox как внешнего приложения, функции доступности которого обеспечены специальным
                  компонентом на&#160;базе AT-SPI, но решение на&#160;основе JavaFX остаётся более предпочтительным.
                </p>
                <h2>
