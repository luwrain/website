...
<h2>Ключевые скрипты в&#160;составе стандартных дистрибутивов LUWRAIN</h2>

<p>Все&#160;дистрибутивы LUWRAIN в&#160;своей комплектации разделяются на&#160;две большие части:
...
отвечающих за&#160;пользовательское восприятие и взаимодействие со&#160;внешними сервисами.</p>

<p>Ниже в&#160;списке приведены ссылки на&#160;наиболее важные скрипты в&#160;составе LUWRAIN:</p>

<ul>
<li>Скрипты с&#160;шаблонами файлов и корректорами для&#160;приложения Студия:
<ul>
<li><a href="https://github.com/luwrain/extensions/blob/master/js/studio-tex.js">Для&#160;файлов в&#160;формате TeX</a></li>
<li><a href="https://github.com/luwrain/extensions/blob/master/js/studio-lilypond.js">Для&#160;файлов в&#160;формате Lilypond</a></li>
</ul></li>
<li><a href="https://github.com/luwrain/extensions/blob/master/js/i18n-ru-natural.js">Корректировка текста на&#160;русском языке для&#160;последующего прочтения синтезатором речи</a></li>
<li><a href="https://github.com/luwrain/extensions/blob/master/js/i18n-ru-natural.js">Корректировка текста на&#160;русском языке для&#160;последующего прочтения синтезатором речи</a></li>
</ul>
