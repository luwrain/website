...
<p>Часть дистрибутивов содержит в&#160;своём составе Java&#160;SE Runtime Environment.
Мы включаем этот компонент, ссылаясь на&#160;следующее разрешение компании Oracle:</p>
...
<p>Товарный знак "LUWRAIN" зарегистрирован на&#160;территории Российской Федерации.
...
Скорее всего, мы не&#160;станем возражать, но, пожалуйста, напишите нам.</p>
<?php }?>
