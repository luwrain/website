...
круг решаемых задачь достаточно сильно различается.</p>

<ol>
<li><strong>LUWRAIN предлагает специализированные приложения, охватывающие нужды незрячих людей.</strong> 
...
LUWRAIN имеет такой функционал, включая поддержку формата Daisy.</li>
...
<li><strong>LUWRAIN гарантирует единообразное поведение системы.</strong>
...
Причём в&#160;случае дистрибутива на&#160;основе GNU/Linux оно состоит только из&#160;свободных компонентов (СПО).</li>
...
<p><strong>Но самая главная особенность LUWRAIN &#x2014; высокая скорость и простота!</strong> 
...
Только в&#160;процессе разработки нам стало ясно, что найденное сочетание решений обеспечивает множество организационных преимуществ.</p>
...
Эта&#160;система очень близка по&#160;замыслу, но&#160;в&#160;последнее время практически не&#160;развивается.</li>
</ol>
<?php }?>
