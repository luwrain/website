...
С тем, как злоумышленники могут использовать утилиты экранного доступа для&#160;взлома компьютеров пользователей, <a href="https://www.cnews.ru/news/top/2019-09-27_tainstvennye_zloumyshlenniki_1">можно ознакомиться в&#160;материале на&#160;CNEWS</a>.</li>
...
Даже бесплатные утилиты экранного доступа не&#160;предоставляют каких-либо полезных функций без&#160;необходимости покупки лицензии на&#160;использование операционной системы или комплекта офисных приложений.
...
и
<a href="https://ru.wikipedia.org/wiki/LilyPond">Lilypond</a>.</li>
<li><strong>Доступ к&#160;Интернет-сервисам.</strong>
...
Наиболее наглядным примером этого движения может служить ожидание массового перехода банков на&#160;предоставление услуг в&#160;подобной форме,
о&#160;чём писал <a href="https://www.kommersant.ru/doc/4060395">Коммерсантъ</a>
и
...
делая его неизбежно уязвимым и вынужденным всегда находиться в&#160;"серой" части экономики.</p>
<?php }?>
