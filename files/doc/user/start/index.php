...
и внести свой вклад в&#160;повышение независимости и самостоятельности  людей с&#160;нарушениями зрения.</p>

<p>Вместе стем, нам крайне интересны вопросы применения ИТ в тифлопедагогике и других сферах,
...
Для&#160;их&#160;решения мы исследуем способы упрощения выпуска изданий в&#160;<a href="https://ru.wikipedia.org/wiki/DAISY">формате Daisy</a>  и создания интерактивных приложений.
...
поэтому мы выделяем это в&#160;отдельное направление.</p>

<p>Если вы желаете к&#160;нам присоединиться, выберите один из&#160;пунктов ниже,
наииболее точно описывающий ваши интересы:</p>
...
<li><a href="<?php echo luwrain_link('organizations/');?>"><strong>Для&#160;организаций:</strong> вы интересуетесь вопросами адаптации  и чтения материалов в&#160;неизуальной форме.</a>]</li>
</ol>
...
<li><a href="<?php echo luwrain_link('/download/');?>">Дистрибутивы LUWRAIN</a></li>
