...
<?php if (luwrain_current_lang() == 'ru') {?>
                ...
                <p>
                  ...
                  их&#160;найти <a href="<?echo luwrain_link('/doc/user/installation/');?>">здесь</a>.
                </p>
                <p>Выберите интересующий вас раздел:</p>
                <ul>
                  <li><a href="<?echo luwrain_link('essentials/');?>">Основные понятия</a></li>
                  <li><a href="<?echo luwrain_link('fundamentals');?>">Основные принципы управления и навигации</a></li>
                </ul>
