<?php include "../../../../functions.php"; luwrain_begin_page('/doc/user/manual/reader/index.php', luwrain_current_lang() == 'ru'?'Просмотр документов':'Documents preview');?>
<?php if (luwrain_current_lang() == 'en') {?>
<h1>Documents preview</h1>
<?php }?>
<?php if (luwrain_current_lang() == 'ru') {?>
<h1>Просмотр документов</h1>

<p>Чтение книг и документов
В качестве идентификатора в этом приложении выступает слово «reader».
Если ввести его в командной строке (командная строка открывается комбинацией клавиш Alt+ X), то запуститься данное приложение.</p>

<p>Оно предназначено для работы с большими документами и книгами.
