...
подразумеваемые под&#160;этим объекты не&#160;являются полноценными приложениями в&#160;полном смысле этого слова,
...
мы полагаем, что у&#160;вас уже есть опыт разработки на&#160;этом языке.
...
<ol>
<li>Иметь установленную Java&#160;SE SDK не&#160;ниже версии 1.8.</li>
