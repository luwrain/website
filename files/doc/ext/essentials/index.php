<?php include "../../../functions.php"; luwrain_begin_page('/doc/ext/essentials/index.php', luwrain_current_lang() == 'ru'?'Основные понятия расширений':'Extensions essentials');?>
...
<?php }?>
<?php luwrain_end_page('/doc/ext/essentials/index.php');?>
