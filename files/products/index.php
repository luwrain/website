...
<p>Всё множество продуктов и услуг, предоставляемых командой LUWRAIN, сосредоточено вокруг нашей одноимённой рабочей среды.
...
<ul>
<li><a href="<?php echo luwrain_link('/download/iso/');?>">В&#160;виде ОС, подготовленной  как для&#160;запуска в&#160;режиме live&#160;CD, так и&#160;для установки на&#160;жёсткий диск</a>
(программа установки не&#160;требует помощи зрячих помощников)</li>
<li>В&#160;виде приложения <a href="<?php echo luwrain_link('/download/windows/');?>">для&#160;Microsoft Windows</a> или <a href="<?php echo luwrain_link('/download/linux/');?>">для&#160;GNU/Linux</a> </li>
</ul>
...
<p><a href="<?php echo luwrain_link('/products/education/');?>">Щёлкните на&#160;этой ссылке, чтобы прочитать подробнее про&#160;наши продукты и услуги для&#160;образования</a></p>

<h2>Для&#160;коммерческих компаний</h2>

<p>Коммерческие компании, общественные организации и государственные учреждения, используя LUWRAIN, имеют возможность 
существенно повысить доступ к&#160;своим продуктам и услугам для&#160;людей с&#160;нарушениями зрения. </p>

<ol>
<li>LUWRAIN позволяет оснащать встраиваемые системы интерфейсом для&#160;пользователей с&#160;нарушениями зрения 
(бытовую технику, терминалы самообслуживания и&#160;т.&#160;д.).</li>
<li>LUWRAIN позволяет создавать и распространять приложения,
которые незрячие люди смогут легко использовать со&#160;своих рабочих мест дома и в&#160;офисе.</li>
</ol>

<p>Команда LUWRAIN готова оказать всю&#160;техническую поддержку или выполнить работы самостоятельно в&#160;рамках наших платных услуг. </p>

<p><a href="<?php echo luwrain_link('/products/business/');?>">Щёлкните на&#160;этой ссылке, чтобы прочитать подробнее про&#160;наши продукты и услуги для&#160;коммерческих компаний</a></p>
<?php }?>
