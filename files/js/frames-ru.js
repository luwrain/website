...
function ShowPart1()
{
    ...
    $('#text1more').html('Команда LUWRAIN развивает инструменты доступа к информационным технологиям'+
			 '<br/>в невизуальной форме. Наша компетенция включает в себя как решение социальных задач,'+
			 '<br/>так и проектирование новых человеко-машинных интерфейсов'+
			 '<br/>для взаимодействия при помощи речевого вывода.'+
			 '<br/>Особую роль в нашей работе играет поддержка людей с нарушениями зрения,'+
			 '<br/>для которых мы ведём активную разработку'+
			 '<br/>программных продуктов и методов адаптаций материалов.');
...
function ShowPart2()
{
	...
	$('#text1more').html('В отличие от экранных чтецов, функционирующих в оконном режиме,'+
			     ...
			     '<br/>Свобода от визуальных концепций позволяет нам предлагать новый пользовательский опыт,'+
