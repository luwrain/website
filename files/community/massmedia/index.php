<?php include "../../functions.php"; luwrain_begin_page('/community/massmedia/index.php', luwrain_current_lang() == 'ru'?'Пресса о нас':'Mass media about us');?>
<?php if (luwrain_current_lang() == 'en') {?>
<h1>Mass media about LUWRAIN</h1>
