...
<p>Для правильной работы LUWRAIN необходимо  наличие речевого синтезатора.
...
Напоминаем, что его исходные тексты хранятся <a href="https://github.com/olga-yakovleva/rhvoice">здесь</a>.</p>
