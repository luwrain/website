...
<?php if (luwrain_current_lang() == 'en') {?>
                ...
                <p>
                  Our&#160;source code is easily accessible in&#160;Git repositories on&#160;<a target="_blank" href="http://github.com/luwrain/">github.com</a>.
                  There are their direct links listed in&#160;several categories with&#160;brief comments.
                </p>
                ...
                <ul>
                  ...
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/i18n.git">git://github.com/luwrain/i18n.git</a>
                    &#x2014; national standards and languages support
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/network.git">git://github.com/luwrain/network.git</a>
                    &#x2014; utilities for network operations
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/extensions.git">git://github.com/luwrain/extensions.git</a>
                    &#x2014; extensions source code
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/website.git">git://github.com/luwrain/website.git</a>
                    &#x2014; website pages and scripts
                  </li>
                </ul>
                <h2>System-dependent parts</h2>
                <ul>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/linux.git">git://github.com/luwrain/linux.git</a>
                    &#x2014; Linux-dependent part of Luwrain
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    &#x2014; Windows-dependent part of Luwrain
                  </li>
                </ul>
                <h2>Linux background services and libraries</h2>
                <ul>
                  <li>
...
<?php if (luwrain_current_lang() == 'ru') {?>
                ...
                <p>
                  Наш&#160;Исходный код хранится и постоянно обновляется в&#160;серии репозиториев Git, расположенных
                ...
                <ul>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/luwrain.git">git://github.com/luwrain/luwrain.git</a>
                    &#x2014; исходный код ядра системы (основная реализация пользовательского окружения)
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/base.git">git://github.com/luwrain/base.git</a>
                  ...
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/i18n.git">git://github.com/luwrain/i18n.git</a>
                    &#x2014; поддержка национальных стандартов и языков
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/network.git">git://github.com/luwrain/network.git</a>
                  ...
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/extensions.git">git://github.com/luwrain/extensions.git</a>
                    &#x2014; исходный код расширений
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/website.git">git://github.com/luwrain/website.git</a>
                    &#x2014; страницы и скрипты веб-сайта
                  </li>
                </ul>
                <h2>Системнозависимый код</h2>
                <ul>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/linux.git">git://github.com/luwrain/linux.git</a>
                    &#x2014; системнозависимая часть для&#160;Linux
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/macos.git">git://github.com/luwrain/macos.git</a>
                  ...
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/windows.git">git://github.com/luwrain/windows.git</a>
                    &#x2014; системнозависимая часть для&#160;Windows
                  </li>
                </ul>
                <h2>Фоновые сервисы и библиотеки для&#160;Linux</h2>
                <ul>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/libdbusspeech.git">git://github.com/luwrain/libdbusspeech.git</a>
                    &#x2014; библиотека для&#160;передачи речевой информации через D-Bus
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/guidecraft.git">git://github.com/luwrain/guidecraft.git</a>
                  ...
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/voiceman.git">git://github.com/luwrain/voiceman.git</a>
                    &#x2014; сервис для&#160;управления выводом речи
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/pointvox.git">git://github.com/luwrain/pointvox.git</a>
                    &#x2014; сервис для&#160;управления речевыми синтезаторами
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/musitorius.git">git://github.com/luwrain/musitorius.git</a>
                    &#x2014; сервис для&#160;управления медиапроигрывателем
                  </li>
                </ul>
                <h2>Приложения</h2>
                <ul>
                  ...
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/app-fetch.git">git://github.com/luwrain/app-fetch.git</a>
                    &#x2014; доставка новостей и электронной почты
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/app-mail.git">git://github.com/luwrain/app-mail.git</a>
                  ...
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/app-message.git">git://github.com/luwrain/app-message.git</a>
                    &#x2014; редактор электронных сообщений
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/app-news.git">git://github.com/luwrain/app-news.git</a>
                    &#x2014; клиент для&#160;чтения новостей
                  </li>
                  <li>
                    <a target="_blank" href="https://github.com/luwrain/app-notepad.git">git://github.com/luwrain/app-notepad.git</a>
