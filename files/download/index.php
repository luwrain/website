...
<li><a href="tarball/">Архивы с&#160;материалами проекта</a> (в&#160;основном предоставляются для&#160;упрощения загрузки LUWRAIN, но помимо исходных текстов содержат также  звуковые файлы, отсутствующие в&#160;репозиториях Git)</li>
