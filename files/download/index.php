<?php include "../functions.php"; luwrain_begin_page('/download/index.php', luwrain_current_lang() == 'ru'?'Загрузка Luwrain':'Luwrain downloads');?>
<?php if (luwrain_current_lang() == 'en') {?>
                ...
                <p>
                  A&#160;couple of&#160;other alternatives are purposed for&#160;development tasks. Which
                  one of&#160;them is suitable for&#160;you is&#160;dependent on&#160;the&#160;sort of&#160;work
                  you are interested&#160;in. Source materials usually serve for&#160;exploring of&#160;software
                  internal implementation or for&#160;development of&#160;Luwrain itself. Binary packages
                  includes Luwrain main jar-file and all auxiliary libraries required for&#160;Luwrain applications
                  development as&#160;well&#160;as for&#160;Luwrain launch on&#160;other distributions of&#160;GNU/Linux.
                </p>
...
<?php if (luwrain_current_lang() == 'ru') {?>
                ...
                <p>
                  ...
                  начинаете знакомство с&#160;Luwrain или Вам нужен дистрибутив просто для&#160;работы, то
                  необходимо выбрать первую опцию из&#160;списка. Она позволяет получить Luwrain в&#160;виде
