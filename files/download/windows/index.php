...
<?php if (luwrain_current_lang() == 'en') {?>
                ...
                <p><b>Target platform:</b> Microsoft Windows 7/8/8.1</p>
                <ul>
                  <li><a href="http://download.luwrain.org/binary/<?php echo luwrain_version_windows();?>/windows/luwrain-windows-<?php echo luwrain_version_windows();?>.zip">luwrain-windows-<?php echo luwrain_version_windows();?>.zip</a></li>
                </ul>
                <h2>See&#160;also</h2>
                <ul>
                  <li>
                    <a href="<?php echo luwrain_link('/doc/user/installation/windows/');?>">Installation instructions for&#160;Microsoft Windows</a>
                  </li>
...
<?php if (luwrain_current_lang() == 'ru') {?>
                ...
                <p><b>Платформа:</b> Microsoft Windows 7/8/8.1</p>
                <ul>
                  <li><a href="http://download.luwrain.org/binary/<?php echo luwrain_version_windows();?>/windows/luwrain-windows-<?php echo luwrain_version_windows();?>.zip">luwrain-windows-<?php echo luwrain_version_windows();?>.zip</a></li>
                </ul>
                <h2>См.&#160;также</h2>
