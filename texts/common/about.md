...
и не~требуя от~пользователя запускать конкретную операционную систему (которая тоже во~многих случаях может быть недоступна организациям по~финансовым причинам).
