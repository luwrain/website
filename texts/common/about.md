...
при~помощи технологий, которые мы разрабатываем.

1. __Использование издательских систем TeX и Lilypond.__
...
диссертаций ([пример](http://marigostra.ru/materials/thesis.pdf) и [его~исходные тексты](http://marigostra.ru/materials/thesis-src.zip)),
книг, статей,
презентаций ([вебинар, посвящённый этой~теме](http://marigostra.ru/materials/KamerataTeX2018.html)),
нотных партитур ([пример](http://marigostra.ru/piano/LittlePrelude.pdf) и [его~исходные тексты](http://marigostra.ru/piano/LittlePrelude.zip))
пр.
1. __Использование GNU/Linux.__
