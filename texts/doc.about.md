...
LUWRAIN ставит своей целью предложить инструментарий, который позволил бы людям с~нарушениями зрения заниматься интеллектуальным трудом и быть больше вовлечёнными в~академическую сферу.
...
[GNU~Lilypond](https://ru.wikipedia.org/wiki/LilyPond) 
и~др.
